...
public class RestauranteBDHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Restaurante> getAllRestaurantesBD(){
        ...
        if(cursor.moveToFirst()){
            do{
                Restaurante auxRestaurante = new Restaurante(cursor.getInt(0),cursor.getString(2),
                        cursor.getString(1),cursor.getString(3),cursor.getInt(4),cursor.getInt(5),cursor.getInt(6));
